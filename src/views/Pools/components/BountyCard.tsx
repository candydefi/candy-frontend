...
const BountyCard = () => {
  ...
  const TooltipComponent = () => (
    <Box>
      ...
      <Box mb="16px">
        {t(
          'Whenever you successfully claim the bounty, you’re also helping out by activating the Auto CANDY Pool’s compounding function for everyone.',
        )}
      </Box>
      <Box style={{ fontWeight: 'bold' }}>
        {t(`Auto-Compound Bounty: %fee%% of all Auto CANDY pool users’ pending yield`, { fee: callFee / 100 })}
      </Box>
    </Box>
  )
